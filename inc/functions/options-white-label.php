...
if (seopress_white_label_help_links_option() =='1') {
	function seopress_white_label_css() {
		...
		if (is_seopress_page() === true || 'seopress_404' === $get_current_screen || 'seopress_bot' === $get_current_screen || 'seopress_backlinks' === $get_current_screen || 'seopress_schemas' === $get_current_screen) {
