...
class seopress_pro_options {
    ...
    public function add_plugin_page() {
        add_submenu_page('seopress-option', __('PRO', 'wp-seopress-pro'), __('PRO', 'wp-seopress-pro'), seopress_capability('manage_options', 'menu'), 'seopress-pro-page', [$this, 'seopress_pro_page']);
