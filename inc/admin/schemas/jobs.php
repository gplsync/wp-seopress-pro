...
function seopress_get_schema_metaboxe_jobs($seopress_pro_rich_snippets_data, $key_schema = 0) {
	...
	<div class="wrap-rich-snippets-item wrap-rich-snippets-jobs">
		...
		<p>
			...
			<input type="text" id="seopress_pro_rich_snippets_jobs_hiring_same_as_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_jobs_hiring_same_as]" placeholder="<?php echo esc_html__('The organization website URL offering the job position.','wp-seopress-pro'); ?>" aria-label="<?php _e('Organization URL','wp-seopress-pro'); ?>" value="<?php $seopress_pro_rich_snippets_jobs_hiring_same_as; ?>" />
		</p>
		<p>
			...
			<input id="seopress_pro_rich_snippets_jobs_hiring_logo_meta" type="text" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_jobs_hiring_logo]" placeholder="<?php echo esc_html__('Select your image','wp-seopress-pro'); ?>" aria-label="<?php _e('Organization logo','wp-seopress-pro'); ?>" value="<?php $seopress_pro_rich_snippets_jobs_hiring_logo; ?>" />
			<input id="seopress_pro_rich_snippets_jobs_hiring_logo_width" type="hidden" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_jobs_hiring_logo_width]" value="<?php $seopress_pro_rich_snippets_jobs_hiring_logo_width; ?>" />
			<input id="seopress_pro_rich_snippets_jobs_hiring_logo_height" type="hidden" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_jobs_hiring_logo_height]" value="<?php $seopress_pro_rich_snippets_jobs_hiring_logo_height; ?>" />
		...
		<p>
			<label for="seopress_pro_rich_snippets_jobs_remote_meta">
				...
				<input
					...
					<?php if ('1' == $seopress_pro_rich_snippets_jobs_remote) echo 'checked="yes"'; ?>
					value="1"
				/>
		</p>
		<p>
